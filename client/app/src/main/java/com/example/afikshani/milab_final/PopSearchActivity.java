...
public class PopSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text = "<p><font color=#999999> We're finding the </font> <font color=#1de9b6>SAFEST</font><font color=#999999> route considering</font></p> <p><font color=#999999>past 206 accidents in your area.</font></p></h2>";
